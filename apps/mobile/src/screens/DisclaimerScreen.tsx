    ...
    return (
        <View style={s.root}>
            <ScrollView contentContainerStyle={s.scroll}>
                <Text style={s.h1}>Avant d’utiliser VigiAero</Text>

                <P title="La radio d’abord">
                    En vol, la voie normale pour signaler un feu reste la radio : contactez
                    l’organisme avec lequel vous êtes en fréquence (FIS, tour, approche). VigiAero
                    complète ce signalement en fournissant des coordonnées exactes ; il ne le
                    remplace pas.
                </P>
                ...
                <P title="Aucune garantie de transmission">
                    ...
                    compte dépend du service destinataire. VigiAero ne garantit ni l’un ni l’autre,
                    et n’a aucune valeur d’alerte tant que le SMS n’est pas parti.
                </P>
                ...
                <P title="Téléphone à bord">
                    L’usage du réseau mobile en vol est encadré par la réglementation applicable à
                    votre aéronef et à votre exploitation. Il vous appartient de vérifier ce que
                    vous avez le droit de faire à bord.
                </P>
            </ScrollView>
